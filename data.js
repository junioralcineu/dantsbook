...
const FEATURED = {
  ...
  pull_pt: "Um livro que pergunta como seria a justiça se te pudesses dar ao luxo de ser honesto sobre ela.",
  priceNow: "$12.95",
  priceWas: "$18.00",
  cover: "cv-ink"
};
...
const OPINIONS = [{
  ...
  where: "Lisbon",
  avatar: "cv-clay",
  text: "I've been reading Dant's letters for four months now. They're the only Sunday email I open before coffee. The piece on Marcus Aurelius made me start a paper notebook again.",
  text_pt: "Leio as cartas do Dant's há quatro meses. São o único email de domingo que abro antes do café. O texto sobre Marco Aurélio fez-me começar um caderno de papel de novo.",
  book: "Meditations",
  rating: 5
}, {
  name: "Theo R.",
  where: "Edinburgh",
  avatar: "cv-ink",
  text: "What I appreciate most: no five-star theatre, no rankings. Dant treats books like company you keep, not products you finish. The Brothers Karamazov essay is the best thing I read in March.",
  text_pt: "O que mais aprecio: sem teatro de cinco estrelas, sem rankings. O Dant trata os livros como companhia que se mantém, não produtos que se acabam. O ensaio sobre Os Irmãos Karamazov foi a melhor coisa que li em março.",
  ...
  where: "Buenos Aires",
  avatar: "cv-olive",
  text: "I came for the philosophy lists, stayed for the slow-reading manifesto. I now read 12 books a year on purpose, and I feel like I read more than ever.",
  text_pt: "Vim pelas listas de filosofia, fiquei pelo manifesto da leitura lenta. Agora leio 12 livros por ano de propósito, e sinto que li mais do que nunca.",
  ...
  where: "Brooklyn",
  avatar: "cv-amber",
  text: "Honest disagreement: I think the take on Plato is too generous. But the page where Dant argues with himself in real time is exactly why I subscribe.",
  text_pt: "Desacordo honesto: acho que a perspetiva sobre Platão é demasiado generosa. Mas a página onde o Dant discute consigo mesmo em tempo real é exatamente a razão pela qual estou subscrito.",
  book: "The Republic",
  rating: 4
}, {
  name: "Hana M.",
  where: "Kyoto",
  avatar: "cv-rose",
  text: "The 'Russian winters' shelf got me through January. I followed it in order, and I think I understand Anna Karenina now in a way no class ever taught me.",
  text_pt: "A prateleira 'Invernos russos' ajudou-me a atravessar janeiro. Segui-a em ordem, e acho que agora entendo Anna Karenina de uma forma que nenhuma aula alguma vez me ensinou.",
  book: "Anna Karenina",
  rating: 5
}, {
  name: "Sam P.",
  where: "Dublin",
  avatar: "cv-moss",
  text: "If I disagree with anything, it's the ban on hot takes. Sometimes a hot take is just an honest one. But Dant earns the slowness — every line feels weighed.",
  text_pt: "Se discordo de algo, é do veto às opiniões precipitadas. Às vezes uma opinião precipitada é simplesmente uma honesta. Mas o Dant merece a lentidão — cada linha parece pesada.",
  book: "Apology",
  rating: 4
}];
...
const PREVIEW_BOOK = {
  ...
  cover: "cv-ink",
  blurb: "A free, two-page preview from Book V — the morning passage that has lived on my fridge for the better part of a decade.",
  blurb_pt: "Uma pré-visualização gratuita de duas páginas do Livro V — a passagem matinal que viveu no meu frigorífico durante cerca de uma década.",
  excerpt: ["At dawn, when you have trouble getting out of bed, tell yourself: \"I have to go to work — as a human being. What do I have to complain of, if I'm going to do what I was born for — the things I was brought into the world to do?\"", "Or is this what I was created for? To huddle under the blankets and stay warm?", "— But it's nicer here.", "So you were born to feel \"nice\"? Instead of doing things and experiencing them? Don't you see the plants, the birds, the ants and spiders and bees going about their individual tasks, putting the world in order, as best they can?", "And you're not willing to do your job as a human being? Why aren't you running to do what your nature demands?", "— But we have to sleep sometime…", "Agreed. But nature set a limit on that — as it did on eating and drinking. And you're over the limit. You've had more than enough of that. But not of working. There you're still below your quota."],
  excerpt_pt: ["Ao amanhecer, quando tens dificuldade em levantar-te, diz a ti mesmo: «Tenho de ir trabalhar — como ser humano. De que me posso queixar, se vou fazer o que nasci para fazer — as coisas para as quais fui trazido ao mundo?»", "Ou é isto para que fui criado? Para ficar encolhido debaixo das coberturas e estar quente?", "— Mas está mais agradável aqui.", "Então nasceste para sentir «agradável»? Em vez de fazer coisas e experienciá-las? Não vês as plantas, os pássaros, as formigas e as aranhas e as abelhas a trabalhar nos seus ofícios individuais, a pôr o mundo em ordem, tanto quanto podem?", "E tu não estás disposto a fazer o teu trabalho como ser humano? Por que não corres para fazer o que a tua natureza exige?", "— Mas temos de dormir às vezes…", "Concordado. Mas a natureza estabeleceu um limite para isso — tal como fez para comer e beber. E tu ultrapassaste o limite. Já tiveste mais do que suficiente. Mas não de trabalhar. Aí ainda estás abaixo da tua quota."]
};

// ── Reading-room encouragements ───────────────────────────────────
const ENCOURAGEMENTS = ["You don't have to finish it tonight.", "Read one paragraph again. Slowly.", "The page isn't going anywhere.", "Notice what you noticed.", "It's okay to put it down for a moment.", "Underline the line that just moved you.", "A book read slowly is read twice.", "You're already further than this morning.", "Take a breath. The author waited centuries.", "If a sentence stopped you, it earned it.", "Re-reading is not failing.", "One quiet hour is more than most people have."];
const ENCOURAGEMENTS_PT = ["Não precisas de acabar esta noite.", "Lê um parágrafo de novo. Devagar.", "A página não vai a lado nenhum.", "Repara no que reparaste.", "Não há problema em pousá-lo por um momento.", "Sublinha a frase que acabou de te tocar.", "Um livro lido devagar é lido duas vezes.", "Já estás mais à frente do que esta manhã.", "Respira fundo. O autor esperou séculos.", "Se uma frase te deteve, ganhou-o.", "Reler não é falhar.", "Uma hora tranquila vale mais do que a maioria das pessoas tem."];
...
const DAILY_QUOTES_EN = [{
  ...
  source: "Flannery O'Connor · Letters"
}];
const DAILY_QUOTES_PT = [{
  text: "Liberdade é pouco. O que desejo ainda não tem nome.",
  source: "Clarice Lispector · A Paixão Segundo G.H."
}, {
  text: "Mestre não é quem sempre ensina, mas quem de repente aprende.",
  ...
  source: "Vinicius de Moraes · Soneto da Fidelidade"
}, {
  text: "Não tive filhos, não transmiti a nenhuma criatura o legado da nossa miséria.",
  source: "Machado de Assis · Memórias Póstumas de Brás Cubas"
}, {
  text: "No meio do caminho tinha uma pedra, tinha uma pedra no meio do caminho.",
  source: "Carlos Drummond de Andrade · No Meio do Caminho"
}, {
  text: "O que não sei fazer, desmancho em poesia.",
  source: "Manoel de Barros"
}, {
  text: "Escrever é uma maldição que salva.",
  source: "Clarice Lispector · A Descoberta do Mundo"
}, {
  text: "Sou um tupi tangendo um alaúde.",
  source: "Mário de Andrade"
}, {
  text: "O sertão é do tamanho do mundo.",
  source: "Guimarães Rosa · Grande Sertão: Veredas"
}, {
  text: "Vou-me embora pra Pasárgada, lá sou amigo do rei.",
  source: "Manuel Bandeira"
}, {
  text: "Não quero faca nem queijo. Quero a fome.",
  source: "Adélia Prado · Bagagem"
}, {
  text: "Feliz aquele que transfere o que sabe e aprende o que ensina.",
